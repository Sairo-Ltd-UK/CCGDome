version: 1.0
builds:
  Build A: # replace with the name for your build
    executableName: CCGDome_DedicatedServer.0.1.x86_64 # the name of your build executable
    buildPath: C:\_Maximalist\_Builds\CCGDome_DedicatedServer.0.1
    excludePaths: # paths to exclude from upload (supports only basic patterns)
      - C:\_Maximalist\_Builds\CCGDome_DedicatedServer.0.1\CCGDome_BurstDebugInformation_DoNotShip\*.*
buildConfigurations:
  Config A: # replace with the name for your build configuration
    build: Build A # replace with the name for your build
    queryType: sqp # sqp or a2s, delete if you do not have logs to query
    binaryPath:  CCGDome_DedicatedServer.0.1.x86_64 # the name of your build executable
    ...
    variables: {}
fleets:
  Fleet A: # replace with the name for your fleet
    buildConfigurations:
      - Config A # replace with the names of your build configuration
    regions:
